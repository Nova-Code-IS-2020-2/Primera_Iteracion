...
<h5 class="card-header text-center">Registro de cliente</h5>
<div class="card-body">

	<form:form  action="crearCliente" method="post" modelAttribute="cliente">
		...
		<div class="form-group">
		    ...
		    <form:input type="password" class="form-control" maxlength="8" path="contr" required="required" />
		</div>
