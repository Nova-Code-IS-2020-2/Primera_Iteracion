...
<body>
    ...
    <div class="container page-name">
        ...
        <h3 class="cat-alim" style="font-family: Actor, sans-serif;">Crear Alimento:</h3>
        <div class="table-responsive table-bordered text-center shadow">
            ...
            <table class="table table-bordered">
                <tbody>
                    ...
                    <tr>
                        <td class="text-left nombre" style="font-family: Actor, sans-serif;">Descripción del Alimento:</td>
                        <td class="text-left"><form:input class="border rounded-0 id-input" path="Descripcion" /></td>
                    </tr>
                    <tr>
