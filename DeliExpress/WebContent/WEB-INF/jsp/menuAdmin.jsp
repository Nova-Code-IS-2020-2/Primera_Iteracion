    ...
    <div class="container page-name">
      ...
      <div class="btn-toolbar">
        <div class="btn-group" role="group">
          ...
          &nbsp;&nbsp;&nbsp;
          <a href="/DeliExpress/agregarRepartidor.jsp"class="btn btn-primary border rounded shadow-sm" role="button" style="color: #6c3313; background-color: #ffffff; border: 1px solid #6c3313!important;">+Repartidor</a>
        </div>
